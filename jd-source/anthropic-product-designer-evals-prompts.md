---
id: anthropic-product-designer-evals-prompts
company: Anthropic
title: Product Designer, Evals & Prompts
sourceUrl: null
sourcePlatform: company-site
orgPlacement: "Product Prompt and Eval Design team, within Product Design"
postedDate: null
reqId: null
...
captureNote: >
  The JD header states only "San Francisco, CA" as location, which is what
  `jobs.json`'s `location` field records. A LinkedIn post by the hiring
  manager (Chelsea Larsson, "Prompt and Eval Design @ Anthropic"), sharing
  this exact posting, separately states "SF is the preferred location for
  this! But NYC is also an option" — included here as context since it's
  outside the posting text itself, per data-integrity rules recording only
  what the JD states. The same post is the source of this role's
  practitioner-testimony corroboration: it names two accepted entry
  backgrounds ("content designers/prompt designers who've worked in AI" and
  "folks who have engineered eval suites for customers and internal teams")
  and states explicitly "This is not a front-end UI content design role."
---
